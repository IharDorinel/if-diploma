...
function App() {
  ...
  const [headerStyle, setHeaderStyle] = useState('header__bigContainer');

  const [headerPagesStyle, setHeaderPagesStyle] = useState('header__page');

  const [logoIsVisible, setLogoIsVisible] = useState(true);

  const [logoBlackIsVisible, setLogoBlackIsVisible] = useState(false);

  const [loupeStyle, setLoupeStyle] = useState('header__loupe');
  ...
  return (
     ...
     <Router>
      <TopSection bagContent={bagContent} headerStyle={headerStyle} headerPagesStyle={headerPagesStyle}
                  setHeaderStyle={setHeaderStyle} setHeaderPagesStyle={setHeaderPagesStyle}
                  loupeStyle={loupeStyle} setLoupeStyle={setLoupeStyle}
                  headerText={headerText} setHeaderText={setHeaderText}
                  logoIsVisible={logoIsVisible} setLogoIsVisible={setLogoIsVisible}
                  logoBlackIsVisible={logoBlackIsVisible} setLogoBlackIsVisible={setLogoBlackIsVisible}/>
       ...
       <Route exact path="/:id" >
       <ItemCard data={data} setBagContent={setBagContent} bagContent={bagContent}
                 setFavorites={setFavorites} favorites={favorites} setHeaderStyle={setHeaderStyle}
                 setHeaderPagesStyle={setHeaderPagesStyle} setLoupeStyle={setLoupeStyle}
                 setHeaderText={setHeaderText} setLogoIsVisible={setLogoIsVisible}
                 setLogoBlackIsVisible={setLogoBlackIsVisible}/>
       </Route>

       <Route exact path="/bag/:id">
       <Bag bagContent={bagContent}/>
       </Route>
...
function MainPage() {
  ...
  <>
  <Category data={data}/>
  <Sale data={data} setHeaderStyle={setHeaderStyle}/>
  <Instagram />
  </>
  )
}
